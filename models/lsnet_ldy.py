...
if __name__ == "__main__":
    # Example usage of the LSConv layer
    x = torch.randn(1, 64, 32, 32).cuda()  # Example input tensor
    ls_conv = LSConv(dim=64).cuda()  # Create an instance of LSConv
    output = ls_conv(x)  # Forward pass
